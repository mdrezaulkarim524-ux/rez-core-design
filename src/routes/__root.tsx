  ...
  head: () => ({
    meta: [
      ...
      { title: "Digital Wholesale Distribution Partner | REZ INTERNATIONAL" },
      {
        name: "description",
        content:
          "Corporate portal of REZ INTERNATIONAL LTD (CRN: 17320050). B2B Wholesale Procurement & Distribution, subject to supplier approval and commercial agreements.",
      },
      ...
      { name: "twitter:description", content: "Corporate portal of REZ INTERNATIONAL LTD (CRN: 17320050). B2B Wholesale Procurement & Distribution, subject to supplier approval and commercial agreements." },
