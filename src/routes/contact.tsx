        ...
        >
          ...
          >
            ...
            {[
              ...
              <circle key={`n-${i}`} cx={cx} cy={cy} r="4" fill="#D4AF37" stroke="none" />
            ))}
            {/* Connection arcs */}
            {[
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <h2 className="mt-2 font-display text-lg font-bold text-foreground">
                      <span className="text-gold break-words" style={{ color: "#D4AF37" }}>
                        {COMPANY.name}
                      </span>
                    </h2>
            ...
            <div className="overflow-hidden rounded-lg border border-border-gold bg-surface">
              ...
              <div className="border-t border-border-gold/40 bg-background px-6 py-5">
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-gold break-words" style={{ color: "#D4AF37" }}>{COMPANY.name}</span> · 8 Sea Road,
