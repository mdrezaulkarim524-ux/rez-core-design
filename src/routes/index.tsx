      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start px-4 py-28 sm:px-6 lg:px-8 lg:py-44">
          <Reveal>
            ...
            <h1 className="mt-5 max-w-4xl font-display text-4xl font-extrabold leading-[1.08] sm:text-5xl lg:text-6xl" style={{ color: "#E0C097" }}>
      ...
      <section className="relative bg-surface py-20 lg:py-28">
        ...
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6">
          <Reveal>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed sm:text-lg" style={{ color: "#E0C097" }}>
